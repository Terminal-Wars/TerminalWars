...
export async function dropdown(x,y,sid,list) {
	...
	let width = 0; let height = list.length*6;
	let y_ = 3;
	...
	for(let n in list) {
		dropdown.events.push({"type":"flat","anchor":"negative","x":3,"y":y_,"width":width,"height":9,"active":0,"hover":0,"text":list[n]["name"],"command":{"command": "attack","arg1":list[n]["damage"]}})
		y_ += 11;
	}
